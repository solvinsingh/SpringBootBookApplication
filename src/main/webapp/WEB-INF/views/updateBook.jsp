...
<body>
	...
	<form:form method="POST"
		action="/SpringBootBookApplication/book/update" modelAttribute="book">
		...
		<div class="container">
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					...
					<td><form:input path="volume" /> <form:errors path="volume"
							cssClass="error" /></td>
				</tr>
				<tr>
					<td><form:label path="publishDate">Publish Date (yyyy-MM-dd):</form:label></td>
					<td><form:input path="publishDate" /> <form:errors
							path="publishDate" cssClass="error" /></td>
				</tr>
				...
				<tr height="50">
					...
					<td><input type="submit" value="Update"   class="btn btn-primary"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" value="Reset"   class="btn btn-primary"/> &nbsp;&nbsp;&nbsp;&nbsp; <a
						href="${contextPath}/SpringBootBookApplication/book/list" class="btn btn-link">Back</a></td>
